...
def test_split_equals_single_reference(gpt_oss_cfg):
    ...
    reference = [MockBlockRuntime(0, 0, gpt_oss_cfg.num_layers - 1)]
...
def test_replay_rebuilds_kv(gpt_oss_cfg):
