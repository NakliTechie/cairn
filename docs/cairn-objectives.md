...
## License & stance
- **Open source.** Clean licenses throughout — Apache-2.0 (gpt-oss, GPT-NeoX), MIT (GLM-5.2); deliberately no OPT/LLaMA-1 (non-commercial/leaked). Model-as-config keeps it model-agnostic.
